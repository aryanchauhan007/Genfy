...
>(({ className, children, showCloseButton = true, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {showCloseButton && (
        <DialogPrimitive.Close className="absolute top-4 right-4 rounded-lg opacity-70 transition-opacity hover:opacity-100 hover:bg-gray-100 focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none p-1 text-gray-500 hover:text-gray-900">
